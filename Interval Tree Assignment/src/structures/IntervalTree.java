...
public class IntervalTree {
	...
	public IntervalTree(ArrayList<Interval> intervals) {
		...
		System.out.println("Now, intervalsRight");
		System.out.println(intervalsRight);
		System.out.println("Now, intervalsLeft");
		System.out.println(intervalsLeft);
		
		// get sorted list of end points without duplicates
		ArrayList<Integer> sortedEndPoints = Sorter.getSortedEndPoints(intervalsLeft, intervalsRight);
		System.out.println(" \n sorted end points list " + sortedEndPoints);
...
//		
		...
		System.out.println("SEE DA INTERVALZ");
		System.out.println("left");
		for (Interval x : root.leftIntervals){
			System.out.println(x);
		}
		System.out.println("right");
		for (Interval x : root.rightIntervals){
			System.out.println(x);
		}
	...
	private static void inorder(IntervalTreeNode d){
		if (d == null){
			return;
		}
		System.out.println("The root: " + d + "| its leftlist: " + d.leftIntervals + " | its rightlist: " + d.rightIntervals);
		inorder(d.leftChild);
